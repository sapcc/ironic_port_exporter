...
IrionicEventGauge = Counter('openstack_ironic_event', 'Ironic node events', ['node_uuid', 'event'])
IrionicEventErrorGauge = Counter('openstack_ironic_errors', 'Ironic node errors', ['node_uuid'])